...
const Navbar = () => {
  ...
  return (
    <nav className="w-[100%] h-[80px] fixed flex items-center justify-between md:px-16 px-6 z-10">
        ...
        <ul className='md:block hidden'>
          ...
          <Link to="/blog" className='py-[15px] px-[25px] text-gray-300 font-bold rounded-md hover:bg-slate-800'>Blog</Link>
        </ul>
        ...
        <div className={`${toggle ? 'block' : 'hidden'} md:hidden block w-[100%] h-[50vh] fixed top-0 left-0 bg-slate-950 px-4`}>
          <ul className='py-16 px-2'>
            ...
            <Link to="/" className='text-white block mt-6'>Blog</Link>  
          </ul>
